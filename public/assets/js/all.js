       ...
       success: function(data) {
           ...
           if (error) {
               ...
               if (status == 200 || status == 300) {
                    ...
                    tblprint += '<strong>' + (status == 200 ? 'Este tipo de usuário não acessa por esta tela.' : 'E-mail ou senha inválidos.') + '</strong>';

               } else {

                   tblprint += '<strong>Ocorreu um erro. Tente novamente.</strong>';
