...
{{-- ------------  Ends hero section --------------- --}}
<section class="hero-section background-container br-home-hero">
    <div class="container">
        <div class="row align-items-center g-4">
            <div class="col-lg-6">
                <div class="br-home-hero-copy">
                    <span class="br-home-eyebrow">@lang('frontend.Safe_Easy_Rides')</span>
                    <h1>@lang('frontend.reliable_way')</h1>
                    <p>@lang('frontend.Your_First_Ride_is_a_Click_Away')</p>
                    <div class="br-home-actions">
                        <a href="#book_Sec" class="btn book-now-main-slider">@lang('frontend.book_now')</a>
                        <a href="tel:{{ Hyvikk::frontend('contact_phone') }}" class="br-home-phone">{{ Hyvikk::frontend('contact_phone') }}</a>
                    </div>
                    <div class="br-home-highlights">
                        <div>
                            <strong>24/7</strong>
                            <span>@lang('frontend.Support')</span>
                        </div>
                        <div>
                            <strong>{{ $vehicle_count ?? (isset($vehicle) ? count($vehicle) : 0) }}+</strong>
                            <span>@lang('frontend.our_vehicle')</span>
                        </div>
                        <div>
                            <strong>100%</strong>
                            <span>@lang('frontend.Safe_Easy_Rides')</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="br-home-visual">
                    <img src="{{ asset('assets/images/slide1.png') }}" alt="@lang('frontend.our_vehicle')" class="br-home-car">
                    <div class="br-home-floating-card">
                        <strong>@lang('frontend.Your_Journey_Always_on_Time')</strong>
                        <span>@lang('frontend.A_promise_for_every_fleet_booking')</span>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-7 col-sm-6 col-md-8  col-lg-8 col-xl-8 col-xxl-8">
                                    <select class="form-select float-end show_vehicle" name="vehicle" required>
                                        <option value='' disabled selected>@lang('frontend.Select_Vehicle')</option>
                                    </select>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.status === 100 && data.data.length > 0) {
                    tblprint += "<option value='' disabled selected>@lang('frontend.Select_Vehicle')</option>";
                    $.each(data.data, function(i, item) {
                        tblprint += "<option value='" + item.id + "'>" + item.model_name + "</option>";
                    });
                } else {
                    tblprint += "<option value='' disabled selected>@lang('frontend.No_Vehicle_Found')</option>";
                }
