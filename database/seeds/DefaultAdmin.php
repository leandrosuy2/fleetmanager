...
class DefaultAdmin extends Seeder
{
    public function run()
    {
        ...
        $team = ['Administrador', 'Gestor de Frota', 'Atendimento', 'Operacoes', 'Suporte'];
        foreach ($team as $name) {
            TeamModel::create(['name' => $name, 'details' => 'Equipe preparada para atender as necessidades da operacao de frota.', 'designation' => 'Responsavel']);
            Testimonial::create(['name' => $name, 'details' => 'Atendimento eficiente e gestao simples para acompanhar veiculos, reservas e despesas.']);
        }
