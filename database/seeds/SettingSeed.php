...
class SettingSeed extends Seeder
{
    ...
    private function default_settings()
    {
        ...
        Settings::create(['label' => 'Website Name', 'name' => 'app_name', 'value' => 'Gerenciador de Frota']);

        Settings::create(['label' => 'Business Address 1', 'name' => 'badd1', 'value' => 'Endereco da empresa 1']);
        Settings::create(['label' => 'Business Address 2', 'name' => 'badd2', 'value' => 'Endereco da empresa 2']);
        Settings::create(['label' => 'Email Address', 'name' => 'email', 'value' => 'master@admin.com']);
        Settings::create(['label' => 'City', 'name' => 'city', 'value' => 'Manaus']);
        Settings::create(['label' => 'State', 'name' => 'state', 'value' => 'Amazonas']);
        Settings::create(['label' => 'Country', 'name' => 'country', 'value' => 'Brasil']);
        Settings::create(['label' => 'Distence Format', 'name' => 'dis_format', 'value' => 'km']);
        Settings::create(['label' => 'Language', 'name' => 'language', 'value' => 'Portuguese-br']);
        Settings::create(['label' => 'Currency', 'name' => 'currency', 'value' => 'R$']);
        ...
        Settings::create(['label' => 'traccar_enable', 'name' => 'traccar_enable', 'value' => 0]);
        Settings::create(['label' => 'traccar_username', 'name' => 'traccar_username', 'value' => '']);
        Settings::create(['label' => 'traccar_password', 'name' => 'traccar_password', 'value' => '']);
        Settings::create(['label' => 'traccar_server_link', 'name' => 'traccar_server_link', 'value' => '']);
        Settings::create(['label' => 'traccar_map_key', 'name' => 'traccar_map_key', 'value' => '']);
        Settings::create(['label' => 'vehicle_interval', 'name' => 'vehicle_interval', 'value' => 45]);
        Settings::create(['label' => 'driver_interval', 'name' => 'driver_interval', 'value' => 60]);
        Settings::create(['label' => 'driver_doc_verification', 'name' => 'driver_doc_verification', 'value' => 0]);
        Settings::create(['label' => 'fotter logo img', 'name' => 'fotter_logo_img', 'value' => 'footer_logo.png']);
        Settings::create(['label' => 'fare mode', 'name' => 'fare_mode', 'value' => 'type_wise']);
        Settings::create(['label' => 'return booking', 'name' => 'return_booking', 'value' => 1]);
    }
    ...
    private function frontend_settings()
    {
        ...
        FrontendModel::create(['key_name' => 'about_title', 'key_value' => 'Atendendo voce com excelencia']);
        FrontendModel::create(['key_name' => 'facebook', 'key_value' => 'https://www.facebook.com/hyvikk/']);
        FrontendModel::create(['key_name' => 'twitter', 'key_value' => 'https://x.com/hyvikks?mx=2']);
        FrontendModel::create(['key_name' => 'instagram', 'key_value' => 'https://www.instagram.com/hyvikk_solutions/?hl=en']);
        FrontendModel::create(['key_name' => 'linkedin', 'key_value' => 'https://in.linkedin.com/company/hyvikk-solutions']);
        ...
        FrontendModel::create(['key_name' => 'language', 'key_value' => 'Portuguese-br']);
    ...
    private function payment_settings()
    {
        ...
        PaymentSettings::create(['name' => 'currency_code', 'value' => 'BRL']);
